<?php
  ...
  if(isset($_POST['generate'])){
    header("Location: uplsexcel.php?export");
  }
...
<p class="form-text" style="font-size: 2rem; font-weight: 800; margin-top: -10px;color: white;">Data Rele UPLS</p>
        ...
        if(count($data)>0)
        {
          ...
          ?>
            <tr>
                ...
                <td><?php echo $value['setting_arus_relay'];?></td>
