            ...
            return this.name + ': ' + Math.floor(this.y);
                    ...
                    data: [
                            ...
                            [
                              ...
                              $jumlahmaintenanceamr = mysqli_query($conn,$selectsql);
            ...
            return this.name + ': ' + Math.floor(this.y);
                    ...
                    data: [
                            ...
                            [
                              ...
                              include "config.php";
                              $nama = "Maintenance";
                              $selectsql2 = "call selectpiegitomohon ()";
                              $jumlahmaintenancetmhn = mysqli_query($conn,$selectsql2);
                              $jumlahtmhn = mysqli_num_rows($jumlahmaintenancetmhn);
                              ?>

                                '<?php echo $nama ?>', <?php echo $jumlahtmhn; ?>
                            ],
                            [
                            <?php 
                              include 'config.php';
