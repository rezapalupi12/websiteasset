<?php
  ...
  if(isset($_POST['generate'])){
    header("Location: dfrexcel.php?export");
  }
...
<p class="form-text" style="font-size: 2rem; font-weight: 800; margin-top: -10px;color: white;">Data DFR</p>
