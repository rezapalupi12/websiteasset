<?php
  ...
  if(isset($_POST['generate'])){
    header("Location: islandexcel.php?export");
  }
    ...
    <header>
        ...
        <nav id="navigation" class="nav">
            <ul class="isi">
                ...
                <li><a href="listunit.php?page=list">List Unit</a></li>
...
<p class="form-text" style="font-size: 2rem; font-weight: 800; margin-top: -10px;color: white;">Data Rele Island</p>
<div class="table-container">
  ...
  <table class="table table-bordered" id="myTable">
    ...
    <tr>
      ...
      <th>Serial Number</th>
      <th>Bay</th>
      <th>Tahapan Setting</th>
      <th>Setting Frekuensi</th>
      <th>Setting Waktu</th>
      <th>Status</th>
    </tr>
    </thead>
        ...
        if(count($data)>0)
        {
          ...
          ?>
            <tr>
                ...
                <td><?php echo $value['tahapan_setting'];?></td>
                <td><?php echo $value['setting_frekuensi'];?></td>
                <td><?php echo $value['setting_waktu'];?></td>
