...
if(isset($_GET['export']))
{
  ...
  $output = "";
        ...
        $output .= '<table class="table table-bordered" border="1">  
                    <tr>
                    <th colspan="9" style="text-align: center;font-size: 30px">Data Rele UFR</th>
                    </tr>
                    <tr>  
                          ...
                          <th scope="col" style="background-color: #808080;">Trafo</th>
...
foreach($data as $key=>$value){
    ...
    $output .= '<tr>  
        ...
        $filename = "Data Rele UFR_".date('Ymd') . ".xls";         
