<?php
  include 'config.php';
  $sql = "call laporannon_maintenance()";
  ...
  if(isset($_POST['generate'])){
    header("Location:non_maintenanceexcel.php?export");
  }
...
<p class="form-text" style="font-size: 2rem; font-weight: 800; margin-top: -10px; color: white;">List Asset Non-Maintenance</p>
