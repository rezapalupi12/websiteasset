...
$pdf->SetFont('Times','',12);
$pdf->cell(110);
$pdf->cell(40,10,'Ukur Ratio VT',0);
...
$location = 'C:/xampp/htdocs/tesweb/laporan/'.$filename.'.pdf';
switch ($pdf->Output("F", $location)) {
    default:
        header("location: downloadpdf.php?unit=$unit&asset=$asset&sn=$sn&tanggal=$tanggal&pengawas=$pengawas&penguji=$penguji&ratio=$ratio");
} 
