<?php
  ...
  if(isset($_POST['generate'])){
    header("Location:maintenanceexcel.php?export");
  }
...
<p class="form-text" style="font-size: 2rem; font-weight: 800; margin-top: -10px;color: white;">List Asset Maintenance</p>
        ...
        if(count($data)>0)
        {
          ...
          ?>
            <tr>
                ...
                <td><?php echo $value['tanggal_maintenance'];?></td>
            </tr>
            <?php
          }
        }
