...
if(isset($_GET['export']))
{
  ...
  $output = "";
        ...
        $output .= '<table class="table table-bordered" border="1">  
                    <tr>
                    <th colspan="12" style="text-align: center;font-size: 30px">Data Rele UPLS</th>
                    </tr>
                    <tr>  
                          ...
                          <th scope="col" style="background-color: #808080;">Setting Arus Rele</th>
                          <th scope="col" style="background-color: #808080;">Setting Waktu</th>
                          <th scope="col" style="background-color: #808080;">Keterangan</th>
...
foreach($data as $key=>$value){
    ...
    $output .= '<tr>  
                         ...
                         <td>'.$value['bay'].'</td>
                         <td>'.$value['ip'].'</td>
                         <td>'.$value['setting_arus_relay'].'</td>
        ...
        $filename = "Data Rele UPLS_".date('Ymd') . ".xls";         
